package br.com.docker.demo.resource;
...
import br.com.docker.demo.service.PessoaService;
...
public class PessoaResource {
	...
	public ResponseEntity<Pessoa> criar(@Valid @RequestBody Pessoa pessoa, HttpServletResponse response) {
		...
		setHeaderLocation(response, pessoaSalva.getCodigo());
	...
	private void setHeaderLocation(HttpServletResponse response, Long codigo) {
